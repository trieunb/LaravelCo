          ...
          <div class="x_content">
            ...
            <form data-parsley-validate class="form-horizontal form-label-left" id="form-category-create">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="description" id="" cols="5" rows="5" class="form-control col-md-7 col-xs-12 description"></textarea>
                </div>
              </div>
...
@endsection
@section('script')
<script src="/modules/admin/category/js/category_create.js"></script>
@endsection